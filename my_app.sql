...
values (upper('Julian'),upper('Vaca'),'correosuperwoa@gmail.com',aes_encrypt('password','$2a$12$71SJ2B6qdXDQrZUF4KR5suDytQ062kLQf/QHbatSw8wLqu1DoMppm'));
...
end_data from users_tbl where used_id= 1;